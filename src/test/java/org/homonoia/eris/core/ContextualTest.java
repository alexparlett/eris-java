...
public class ContextualTest {
    ...
    public void testSubscribeEventAction() throws Exception {
        ...
        verify(EndHandlerMock, times(1)).call(ArgumentMatchers.any());
    }
    ...
    public void testUnsubscribe() throws Exception {
        ...
        verify(EndHandlerMock, never()).call(ArgumentMatchers.any());
        verify(BeginFrameHandlerMock, never()).call(ArgumentMatchers.any());
    ...
    public void testUnsubscribeEventClass() throws Exception {
        ...
        verify(EndHandlerMock, never()).call(ArgumentMatchers.any());
        verify(BeginFrameHandlerMock, times(1)).call(ArgumentMatchers.any());
    }
