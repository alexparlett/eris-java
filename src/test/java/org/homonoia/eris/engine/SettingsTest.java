...
public class SettingsTest {
    ...
    public void testGetSetting_Successful() throws IOException {
        ...
        MatcherAssert.assertThat(settings.getString("Section1", "Foo1").get(), Is.is("Bar"));
        MatcherAssert.assertThat(settings.getInteger("Section1", "Foo2").get(), Is.is(2));
        MatcherAssert.assertThat(settings.getBoolean("Section2", "Foo3").get(), Is.is(true));
        MatcherAssert.assertThat(settings.getFloat("Section2", "Foo4").get(), Is.is(2.0f));
    }
    ...
    public void testGetSetting_SuccessfulPropertyNotFound() throws IOException {
        ...
        MatcherAssert.assertThat(settings.getString("Section1", "Foo3").isPresent(), Is.is(false));
    }
    ...
    public void testGetSetting_SuccessfulSectionNotFound() throws IOException {
        ...
        MatcherAssert.assertThat(settings.getString("Section3", "Foo3").isPresent(), Is.is(false));
    }
    ...
    public void testSetSetting_SuccessfulAlreadyExists() throws IOException {
        ...
        MatcherAssert.assertThat(settings.getInteger("Section1", "Foo1").get(), Is.is(1));
    }
    ...
    public void testSetSetting_SuccessfulSectionAlreadyExists() throws IOException {
        ...
        MatcherAssert.assertThat(settings.getInteger("Section1", "Foo3").get(), Is.is(1));
    }
    ...
    public void testSetSetting_SuccessfulDoesntExists() throws IOException {
        ...
        MatcherAssert.assertThat(settings.getInteger("Section3", "Foo5").get(), Is.is(1));
    }
    ...
    public void testSave_Successful() throws Exception {
        ...
        MatcherAssert.assertThat(Stream.of(fileList).findAny().isPresent(), Is.is(true));
    }
