...
public class ComponentFactory extends Contextual {
    ...
    public <T extends Component> T newInstance(Class<T> clazz) {
        try {
            ...
            throw new InvalidComponentException("Cannot create Component of {}", clazz.getCanonicalName(), e);
        }
    }
    ...
    public <T extends Component> T newInstance(String name) {
        try {
            ...
            throw new InvalidComponentException("Cannot create Component of {}", name, e);
        }
    }
}
