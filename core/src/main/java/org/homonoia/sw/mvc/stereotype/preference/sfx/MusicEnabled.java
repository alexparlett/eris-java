package org.homonoia.sw.mvc.stereotype.preference.sfx;
...
/** Should annotate either name of the preference containing music setting or a boolean variable with the initial value.
 *
 * @author MJ */
