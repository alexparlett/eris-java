...
import org.homonoia.sw.mvc.stereotype.ViewStage;
...
public abstract class AbstractAnnotatedController {
    ...
    /** @param stage will be injected into {@link ViewStage}-annotated field, if
     *            present. */
    ...
    /** Will inject null into {@link ViewStage}-annotated field. */
