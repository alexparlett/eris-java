package org.homonoia.sw.mvc.component.ui;
...
import org.homonoia.sw.mvc.component.ui.action.ActionProvider;
import org.homonoia.sw.mvc.component.ui.action.ApplicationExitAction;
import org.homonoia.sw.mvc.component.ui.action.ApplicationPauseAction;
import org.homonoia.sw.mvc.component.ui.action.ApplicationResumeAction;
import org.homonoia.sw.mvc.component.ui.action.CommonActionRunnables;
import org.homonoia.sw.mvc.component.ui.action.DialogShowingAction;
import org.homonoia.sw.mvc.component.ui.action.MusicFadingAction;
import org.homonoia.sw.mvc.component.ui.action.ScreenTransitionAction;
...
import org.homonoia.sw.mvc.component.ui.controller.ViewPauser;
...
import org.homonoia.sw.mvc.component.ui.controller.impl.StandardViewRenderer;
import org.homonoia.sw.mvc.component.ui.controller.impl.StandardViewResizer;
import org.homonoia.sw.mvc.component.ui.controller.impl.StandardViewShower;
import org.homonoia.sw.mvc.component.ui.dto.provider.ViewActionProvider;
        ...
        return new ActionProvider() {
            ...
            public Action provideAction(final ViewController forController, final ViewController nextController) {
                ...
                if (currentTheme == null || isThemeAvailableInNextView(nextController, currentTheme)) {
                    return Actions.sequence(Actions.fadeOut(DEFAULT_FADING_TIME));
                }
